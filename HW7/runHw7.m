...
grid_MN = [26, 34];              % Number of rows and cols in the grid
...
template_half_window_size = 13; % Half size of the template window 
grid_MN = [8, 11]; % Number of rows and cols in the grid
...
tracking_params.rect = [138 108 81 84];

% Half size of the search window
tracking_params.search_half_window_size = 6;
% Number of bins in the color histogram
tracking_params.bin_n = 5; 
...
tracking_params.rect = [303 210 53 130];

% Half size of the search window
tracking_params.search_half_window_size = 9;
% Number of bins in the color histogram
tracking_params.bin_n = 3;           
